...
CFLAGS="-O3 -Wall -W -Wextra -I$ROOT_FS/include/libdrm -I$ROOT_FS/include -I$ROOT_FS/include/xorg -I$MALI_DDK/include -I$MALI_DDK/internal/include/khronos" \
LDFLAGS="-L$ROOT_FS/lib -lMali -lpthread" \
